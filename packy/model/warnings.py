...
class Warnings:
    ...
    def __repr__(self):
        ...
        return (
            f"warnings: added_items = [{repr_added_items}], removed_items = [{repr_removed_items}]"
        )

    # -------------------------------------------------------------------------
    def __eq__(self, other):
        return (
            self.__added_items == other.__added_items
            and self.__removed_items == other.__removed_items
        )
